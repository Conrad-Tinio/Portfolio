...
const skills = [
  ...
  {name: "DjangoDB", level: 90, category: "backend"},
...
export default function SkillsSection() {
  ...
  const filteredSkills = skills.filter(
    (skill) => activeCategory === "all" || skill.category === activeCategory  // If the activeCategory === "all", everything will show : activeCategory === activeCategory
  );
  return (
